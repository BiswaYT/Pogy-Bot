...
module.exports = class extends Command {
    ...
    const prefix = guildDB.prefix;
      ...
      const green = '<:purple:887555478945665086>';
      const red = '<:redsquare:887553258552434699>';
      ...
      if (!args || args.length < 1) {
       ...
       categories = this.client.utils.removeDuplicates(this.client.commands.filter(cmd => cmd.category !== 'Owner').map(cmd => cmd.category));
        ...
        <:purple:887555478945665086> The Prefix for this server is \`${prefix}\`
...
embed.addField(
        '\u200b', 
        '**[Invite](https://discord.com/api/oauth2/authorize?client_id=892817120847626251&permissions=8&scope=bot) | ' +
        '[Support Server](https://discord.gg/HXcBmvJ3Gx) **'
      );
...
embed.addField(
        ...
        if(cmd.examples && cmd.examples.length) embed.addField('__**Examples**__', cmd.examples.map(example => `<:purple:887555478945665086> \`${example}\``).join('\n'))
