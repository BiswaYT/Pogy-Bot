...
var url = req.protocol + '://' + req.get('host') + req.originalUrl;
    ...
    app.get("/support", (req, res) => {
      res.redirect(`https://discord.gg/HXcBmvJ3Gx`)
    });
...
res.redirect(`https://discord.com/api/oauth2/authorize?client_id=892817120847626251&permissions=8&redirect_uri=https%3A%2F%2FPogy-1.bqnbiswa.repl.co&scope=bot`)
});
